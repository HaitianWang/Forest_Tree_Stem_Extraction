...
%------------------------------------------------------------------------
    ...
    rootTLSData = '/media/ibrahim/9cfd0642-7019-4875-9519-d9bd91f84711/FORESTDATARESULTS23/FPCBZ42_01_Output_laz1_4/SegmentedTrees';
    rootResults = '/home/ibrahim/Downloads/Point-Cloud-Tools-main/PCT';
    % Filenames
    filenameTLS = 'FPCBZ42_01_Output_laz1_4_clipped.las';
    ...
    %%% 2. DETECT TREE CROWN SEGMENTS 
        chmPixelSize = 0.5;          % raster cell size in meters
        minCrownArea = 2;            % min crown area in m^2
        viewFigures = false;         % view figures
        Rdir = '/usr/bin/R'; % Directory to R.exe
